    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Update reference velocity ref_v with speed controller
          speed_controller(cars_s,cars_s_delta,cars_d,cars_v,lane_target,end_path_s,ego_v,ego_s,
                            acc_dominant,too_close,prev_size,ref_v);
